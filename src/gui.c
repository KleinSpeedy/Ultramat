...
static void create_window_top_header(GtkStackSwitcher *mainStackSwitcher, GtkSwitch *mainMotorSwitch, GtkBox *mainBox);
...
create_main_motor_switch(void)
{
    ...
    g_handlerIdMotorSwitch = g_signal_connect(motorSwitch, "state-set",
                                              G_CALLBACK(on_motor_switch_toggle), NULL);

    return motorSwitch;
}
static void
create_window_top_header(GtkStackSwitcher *mainStackSwitcher, GtkSwitch *mainMotorSwitch, GtkBox *mainBox)
{
